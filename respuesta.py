...
if iniciar == 1:
    preguntas = cargar_preguntas_desde_archivo(r"C:\Users\mateo\OneDrive\Documentos\programacion 1\programacion 1\ultimo_1\doctor.txt")
    
    if not preguntas:
        print("No se cargaron preguntas. Revisa el archivo doctor.txt.")
        exit()
